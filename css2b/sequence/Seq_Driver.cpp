...
char get_user_command(){ 
	char command;
	cout << "Enter choice: "; cin >> command; 
	return command;
}
void show_sequence(caudillo_sequence::Sequence display){ 
...
int main(){
	...
	caudillo_sequence::Sequence test; // A sequence that we’ll perform tests on 
